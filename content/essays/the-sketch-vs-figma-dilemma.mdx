---
title: Designing through frustration
...
import uiMock1 from './images/ui-mock.webp'
import uiMock2 from './images/ui-mock-2.webp'
import uiMock3 from './images/ui-mock-3.webp'
import billCallahanPrint from './images/bill-callahan-print.jpg'
...
<div className="mb-8 max-w-4xl mx-auto">
  <ImageSet columns={2}>
    <Image src={uiMock1} caption="Negative space has a positive effect" />
    <Image src={uiMock2} alt="placeholder" caption="A light and airy UI mockup" />
  </ImageSet>
</div>
...
I distinctly remember how much [hatred](https://www.google.com) I had in my heart when I lived through my first UI update. The year was 2009; I had just gotten my braces off and I was ready to smash that ‘Like’ button on my high school crush’s status when I logged into Facebook the first time that week. I was devastated to find that something looked a miss. Text navigation was replaced with iconography, event reminders were further down on the page, and it was altogether unsettling. 

<div className="mb-8 max-w-4xl mx-auto">
<ImageSet columns={1}>
  <Image src={billCallahanPrint} alt="placeholder" caption="A single large image"/>
</ImageSet>
</div>
...
<div className="mb-8 max-w-4xl mx-auto">
  <ImageSet columns={3}>
    <Image src={uiMock1} alt="placeholder" />
    <Image src={uiMock2} alt="placeholder" />
    <Image src={uiMock3} alt="placeholder" />
  </ImageSet>
</div>
